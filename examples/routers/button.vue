<template>
    <div>
        ...
        <Button type="primary" to="/" size="large" shape="circle"
            >普通按钮</Button
        >
        <br />
        <br />
        <br />
        <Button type="primary" icon="ios-information-circle" size="small"
            >Search</Button
        >
        <Button type="primary" icon="ios-information-circle" size="default"
            >Search</Button
        >
        <Button type="primary" icon="ios-information-circle" size="large"
            >Search</Button
        >
        <br />
        <br />
        ...
        <Button> <Icon type="md-alert" />左右图标 </Button>
        <Button icon="md-alert">左右图标</Button>
        <Divider></Divider>
        <div>
            ...
            <Button
                ...
                shape="circle"
            ></Button>
            <Button :size="buttonSize" icon="md-download" type="primary"
                >Download</Button
            >
            <br />
            <br />
        ...
        <Button :to="{ path: '/icon' }" target="_blank"
            >Router 对象跳转(_blank)</Button
        >
    </div>
</template>
<script>
