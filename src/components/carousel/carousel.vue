...
export default {
    ...
    computed: {
        ...
        trackStyles() {
            // #6076
            const visibleStyle =
                this.trackIndex === -1 ? 'hidden' : 'visible';
            return {
                width: `${this.trackWidth}px`,
                transform: `translate3d(${-this
                    .trackOffset}px, 0px, 0px)`,
    ...
    methods: {
        ...
        initCopyTrackDom() {
            this.$nextTick(() => {
                this.$refs.copyTrack.innerHTML =
                    this.$refs.originTrack.innerHTML;
            });
        },
        updateSlides(init) {
            let slides = [];
        ...
        updatePos() {
            ...
            this.trackWidth =
                (this.slides.length || 0) * this.listWidth;
        },
        ...
        handleResize() {
            this.listWidth = parseInt(
                getStyle(this.$el, 'width')
            );
            this.updatePos();
            this.updateOffset();
        },
        ...
        add(offset) {
            ...
            this.currentIndex =
                index === this.slides.length ? 0 : index;
        ...
        updateOffset() {
            this.$nextTick(() => {
                ...
                this.trackOffset =
                    this.trackIndex * this.listWidth;
