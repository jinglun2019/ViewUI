...
export default {
    ...
    computed: {
        ...
        inputPlaceholder() {
            return this.filterable && this.currentValue.length
                ? null
                : this.localePlaceholder;
        },
        localeNotFoundText() {
    ...
    methods: {
        ...
        getValidData(data) {
            function deleteData(item) {
                ...
                if (
                    'children' in new_item &&
                    new_item.children.length
                ) {
                    new_item.children = new_item.children.map(
                        i => deleteData(i)
                    );
                }
                return new_item;
    ...
    created() {
        this.validDataStr = JSON.stringify(
            this.getValidData(this.data)
        );
