        ...
        <div :class="panelBodyClasses">
            ...
            >
                ...
                <component
                    ...
                    :value="
                        preSelecting.left ? [dates[0]] : dates
                    "
...
export default {
    ...
    data() {
        ...
        const leftPanelDate = this.startDate
            ? this.startDate
            : minDate;
    ...
    computed: {
        classes() {
            return [
                ...
                {
                    [`${prefixCls}-with-sidebar`]:
                        this.shortcuts.length,
                    [`${datePrefixCls}-with-week-numbers`]:
    ...
    watch: {
        value(newVal) {
            ...
            this.setPanelDates(
                this.startDate || this.dates[0] || new Date()
            );
        },
    ...
    methods: {
        ...
        panelLabelConfig(direction) {
            ...
            const datePanelLabel = this.t(
                'i.datepicker.datePanelLabel'
            );
            const handler = type => {
                const fn =
                    type == 'month'
            ...
            return {
                ...
                labels: labels.map(
                    obj => (
                        (obj.handler = handler(obj.type)), obj
                    )
                )
            };
        },
