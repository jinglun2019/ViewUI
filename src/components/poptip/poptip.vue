...
export default {
    ...
    computed: {
        ...
        contentClasses() {
            return [
                ...
                {
                    [`${prefixCls}-body-content-word-wrap`]:
                        this.wordWrap
                }
            ];
        },
    ...
    methods: {
        ...
        getInputChildren() {
            const $input =
                this.$refs.reference.querySelectorAll('input');
            const $textarea =
                this.$refs.reference.querySelectorAll(
                    'textarea'
                );
            let $children = null;
    ...
    mounted() {
        if (!this.confirm) {
            ...
            this.showTitle =
                this.$slots.title !== undefined || this.title;
        }
