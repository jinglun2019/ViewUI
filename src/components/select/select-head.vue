<template>
    <div @click="onHeaderClick" :class="headCls">
        ...
        <div
            ...
            v-if="
                maxTagCount === undefined || index < maxTagCount
            "
        >
            <span
                class="ivu-tag-text"
        ...
        <input
            ...
            :placeholder="
                showPlaceholder ? localePlaceholder : ''
            "
            :style="inputStyle"
            autocomplete="off"
            spellcheck="false"
...
export default {
    ...
    computed: {
        singleDisplayClasses() {
            const { filterable, multiple, showPlaceholder } =
                this;
            return [
                {
        ...
        singleDisplayValue() {
            if (
                (this.multiple && this.values.length > 0) ||
                this.filterable
            )
                return '';
            return (
    ...
    methods: {
        ...
        resetInputState() {
            this.inputLength =
                this.$refs.input.value.length * 12 + 20;
