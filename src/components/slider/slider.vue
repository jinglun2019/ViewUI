...
export default {
    ...
    computed: {
        ...
        minButtonClasses() {
            return [
                `${prefixCls}-button`,
                {
                    [`${prefixCls}-button-dragging`]:
                        this.pointerDown === 'min'
                }
            ];
        },
        maxButtonClasses() {
            return [
                ...
                {
                    [`${prefixCls}-button-dragging`]:
                        this.pointerDown === 'max'
                }
            ];
        },
        exportValue() {
            const decimalCases = (
                String(this.step).split('.')[1] || ''
            ).length;
    ...
    methods: {
        ...
        onPointerDragStart(event) {
            ...
            this.startPos =
                (this[`${this.pointerDown}Position`] *
                    this.valueRange) /
                    100 +
                this.min;
        },
        ...
        changeButtonPosition(newPos, forceType) {
            ...
            const modulus = this.handleDecimal(
                newPos,
                this.step
            );
