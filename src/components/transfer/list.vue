    ...
    computed: {
        ...
        bodyClasses() {
            return [
                `${this.prefixCls}-body`,
                {
                    [`${this.prefixCls}-body-with-search`]:
                        this.filterable,
                    [`${this.prefixCls}-body-with-footer`]:
                        this.showFooter
                }
            ];
        },
        ...
        checkedAll() {
            return (
                this.filterData.filter(data => !data.disabled)
                    .length === this.validKeysCount &&
    ...
    methods: {
        itemClasses(item) {
            return [
                ...
                {
                    [`${this.prefixCls}-content-item-disabled`]:
                        item.disabled
                }
            ];
        },
