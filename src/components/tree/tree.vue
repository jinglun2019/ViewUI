    ...
    methods: {
        compileFlatState() {
            ...
            function flattenChildren(node, parent) {
                ...
                if (typeof parent != 'undefined') {
                    flatTree[node.nodeKey].parent =
                        parent.nodeKey;
                    flatTree[parent.nodeKey][childrenKey].push(
                        node.nodeKey
                    );
                }
        ...
        rebuildTree() {
            ...
            checkedNodes.forEach(node => {
                ...
                // propagate upwards
                const parentKey =
                    this.flatState[node.nodeKey].parent;
        ...
        handleSelect(nodeKey) {
            ...
            if (!this.multiple) {
                ...
                const currentSelectedKey =
                    this.flatState.findIndex(
                        obj => obj.node.selected
                    );
                if (
                    currentSelectedKey >= 0 &&
                    currentSelectedKey !== nodeKey
                )
                    this.$set(
        ...
        handleContextmenu({ data, event }) {
            ...
            this.$nextTick(() => {
                ...
                const position = {
                    left: `${
                        event.clientX - TreeBounding.left
                    }px`,
